...
ChampionsSatchel.Quality.BLUE.set();
ChampionsSatchel.ContainerSlots.set(24);

//Worg Loot
addLootToCreature(WorgChampionCreatureLoot, [ChampionsSatchel.ID], [10], 0);
addLootToCreatureSingleChance(
    WorgChampionCreatureLoot,
    [
        HeavenlyPurpose.ID,
        PrimalFury.ID,
        Introspection.ID,
...
//Murloc Loot
addLootToCreature(MurlocChampionCreatureLoot, [ChampionsSatchel.ID], [10], 0);
addLootToCreatureSingleChance(
    MurlocChampionCreatureLoot,
    [
        HeavenlyPurpose.ID,
        PrimalFury.ID,
        Introspection.ID,
...
//Kobold Loot
addLootToCreature(KoboldChampionCreatureLoot, [ChampionsSatchel.ID], [10], 0);
addLootToCreatureSingleChance(
    KoboldChampionCreatureLoot,
    [
        HeavenlyPurpose.ID,
        PrimalFury.ID,
        Introspection.ID,
...
//Harpy Loot
addLootToCreature(harpyCreatureLoot, [ChampionsSatchel.ID], [10], 0);
addLootToCreatureSingleChance(
    harpyCreatureLoot,
    [
        HeavenlyPurpose.ID,
...
//Quailboar Loot
addLootToCreature(quailboarCreatureLoot, [ChampionsSatchel.ID], [10], 0);
addLootToCreatureSingleChance(
    quailboarCreatureLoot,
    [
        HeavenlyPurpose.ID,
        PrimalFury.ID,
        Introspection.ID,
