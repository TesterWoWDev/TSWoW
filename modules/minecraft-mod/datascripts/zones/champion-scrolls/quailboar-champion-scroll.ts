...
export let quailboarCreature = std.CreatureTemplates.create(
    MODNAME,
    "quailboarcreature-creature",
    299
);
...
//Spells
export let quailboarSpell1 = std.Spells.create(
    MODNAME,
    "quailboarspell1-spell",
    55323
);
...
quailboar.Description.enGB.set(
    "Summons a powerful Quailboar Champion to fight."
);
quailboar.Effects.get(0).MiscValueA.set(quailboarCreature.ID);

/*Item - Champion Scroll : Worg*/
export let quailboarScroll = std.Items.create(
    MODNAME,
    "quailboarcroll-1",
    33457
);
quailboarScroll.Name.enGB.set("Champion Scroll : Quailboar");
quailboarScroll.Description.enGB.set(
    "This scroll contains the ability to summon a powerful Quailboar, be weary, it is advised that this challenge be accepted with additional party members."
);
...
export let quailboarCreatureSpawn = std.CreatureTemplates.create(
    MODNAME,
    "quailboarcreaturespawn-creature",
    8776
);
...
export let chancequailboar1 = std.Spells.create(
    MODNAME,
    "chancequailboar1-spell",
    13049
); //15283
chancequailboar1.Name.enGB.set("Summon Quailboar");
chancequailboar1.Effects.get(0).MiscValueA.set(quailboarCreatureSpawn.ID);
export let chancequailboar1m = std.Spells.create(
    MODNAME,
    "chancequailboar1m-spell",
    67670
); //melee
chancequailboar1m.Name.enGB.set("Summon Quailboar");
chancequailboar1m.Description.enGB.set(
    "Your attacks and abilties have the chance to summon a ravaging Quailboar to fight for you."
);
chancequailboar1m.AuraDescription.enGB.set(
    "Your attacks and abilties have the chance to summon a ravaging Quailboar to fight for you."
);
chancequailboar1m.Effects.get(0).TriggerSpell.set(chancequailboar1.ID);
export let chancequailboar1c = std.Spells.create(
    MODNAME,
    "chancequailboar1c-spell",
    67672
); //caster
chancequailboar1c.Name.enGB.set("Summon Quailboar");
chancequailboar1c.Description.enGB.set(
    "Your attacks and abilties have the chance to summon a ravaging Quailboar to fight for you."
);
chancequailboar1c.AuraDescription.enGB.set(
    "Your attacks and abilties have the chance to summon a ravaging Quailboar to fight for you."
);
