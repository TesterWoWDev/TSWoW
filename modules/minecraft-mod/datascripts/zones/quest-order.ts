...
import { WarriorQuest01, WarriorQuest02 } from "./(Zone-5)Mall/ClassQuests/WarriorClassQuest";
 ...
 SQL.quest_template_addon.add(DeathknightQuest02.ID).NextQuestID.set(0).PrevQuestID.set(DeathknightQuest01.ID).ExclusiveGroup.set(0).AllowableClasses.set(32)
 SQL.quest_template_addon.add(DruidQuest02.ID).NextQuestID.set(0).PrevQuestID.set(DruidQuest01.ID).ExclusiveGroup.set(0).AllowableClasses.set(1024)
 SQL.quest_template_addon.add(HunterQuest02.ID).NextQuestID.set(0).PrevQuestID.set(HunterQuest01.ID).ExclusiveGroup.set(0).AllowableClasses.set(4)
 SQL.quest_template_addon.add(MageQuest02.ID).NextQuestID.set(0).PrevQuestID.set(MageQuest01.ID).ExclusiveGroup.set(0).AllowableClasses.set(128)
 SQL.quest_template_addon.add(PaladinQuest02.ID).NextQuestID.set(0).PrevQuestID.set(PaladinQuest01.ID).ExclusiveGroup.set(0).AllowableClasses.set(2)
 SQL.quest_template_addon.add(PriestQuest02.ID).NextQuestID.set(0).PrevQuestID.set(PriestQuest01.ID).ExclusiveGroup.set(0).AllowableClasses.set(16)
 SQL.quest_template_addon.add(RogueQuest02.ID).NextQuestID.set(0).PrevQuestID.set(RogueQuest01.ID).ExclusiveGroup.set(0).AllowableClasses.set(8)
 SQL.quest_template_addon.add(ShamanQuest02.ID).NextQuestID.set(0).PrevQuestID.set(ShamanQuest01.ID).ExclusiveGroup.set(0).AllowableClasses.set(64)
 SQL.quest_template_addon.add(WarlockQuest02.ID).NextQuestID.set(0).PrevQuestID.set(WarlockQuest01.ID).ExclusiveGroup.set(0).AllowableClasses.set(256)
 SQL.quest_template_addon.add(WarriorQuest02.ID).NextQuestID.set(0).PrevQuestID.set(WarriorQuest01.ID).ExclusiveGroup.set(0).AllowableClasses.set(1)
