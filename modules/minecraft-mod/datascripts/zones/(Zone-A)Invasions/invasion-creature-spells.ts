...
InvasionFrostbolt.CastTime.modRef(val=>val.set(3000,0,3000))
...
InvasionFrostNova.Duration.modRef(val=>val.set(4500,0,4500))
...
InvasionFrostArmor.Duration.modRef(val=>val.set(120000,0,120000))
...
InvasionBoarCharge.Duration.modRef(val=>{
    val.set(3000,0,3000)
})
