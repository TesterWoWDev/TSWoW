...
// Magic Spells
export let InvasionFrostbolt = std.Spells.create(
    MODNAME,
    "invasionfrostbolt-spell",
    116
);
...
export let InvasionWhirlwind = std.Spells.create(
    MODNAME,
    "InvasionWhirlwind-spell",
    67037
);
InvasionWhirlwind.Name.enGB.set("Whirlwind");

export let InvasionStrike = std.Spells.create(
    MODNAME,
    "InvasionStrike-spell",
    12057
);
...
export let BossDummySpell1 = std.Spells.create(
    MODNAME,
    "bossdummyspell1-spell",
    77
);
BossDummySpell1.Name.enGB.set("Flame Wave");

export let InvasionFlameWave = std.Spells.create(
    MODNAME,
    "invasionflamewave-spell",
    57492
);
