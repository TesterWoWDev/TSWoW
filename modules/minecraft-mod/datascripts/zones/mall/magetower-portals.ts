...
SQL.spell_target_position.add(FortHopePortal.ID,0).MapID.set(723).PositionX.set(-8329.507).PositionY.set(1792.111).PositionZ.set(-71.16).Orientation.set(4.7550)
...
SQL.spell_target_position.add(DauntlessPortal.ID,0).MapID.set(723).PositionX.set(-7944.937).PositionY.set(-361.08).PositionZ.set(-64.7468).Orientation.set(0.00)
...
SQL.spell_target_position.add(ApothecaryPortal.ID,0).MapID.set(723).PositionX.set(-9002.322).PositionY.set(-90.86).PositionZ.set(-6.1379).Orientation.set(4.76)
...
SQL.spell_target_position.add(StoneCirclePortal.ID,0).MapID.set(723).PositionX.set(-8857.813).PositionY.set(411.334).PositionZ.set(5.50).Orientation.set(4.955)
...
SQL.spell_target_position.add(JeweloftheSeaPortal.ID,0).MapID.set(723).PositionX.set(-8344.869).PositionY.set(-395.718).PositionZ.set(42.1914).Orientation.set(2.211)
