...
export let PortaltoFortHope = std.GameObjectTemplates.create(MODNAME,'forthope-object',183325)
...
export let PortaltoDauntless = std.GameObjectTemplates.create(MODNAME,'dauntless-object',183325)
...
export let PortaltoApothecary = std.GameObjectTemplates.create(MODNAME,'apothecary-object',183325)
...
export let PortaltoStoneCircle = std.GameObjectTemplates.create(MODNAME,'stonecircle-object',183325)
...
export let PortaltoJewelofSea = std.GameObjectTemplates.create(MODNAME,'jewelofsea-object',183325)
