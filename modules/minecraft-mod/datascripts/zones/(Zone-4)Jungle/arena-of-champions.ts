...
export let ArenaofChampionsChest = makeResourceNode(
    "Arena Champion's Chest",
    259,
    57,
    "arenachampion-chest"
);
...
addLootSingleChance(
    ...
    [
        EyeofGruul.ID,
        DragonspineTrophy.ID,
        MoroesLuckyPocketWatch.ID,
        RomulosPoisonVial.ID,
        LightningCapacitor.ID,
        VioletEye.ID,
    ],
    16.5,
    4
...
addLootSingleChance(
    ArenaofChampionsChest,
    [Sulfuras.ID, Thunderfury.ID, WarglaiveMH.ID, WarglaiveOH.ID, Thoridal.ID],
    1,
    6
);
/*Money Bags*/
...
spawnGobTimer(
    ArenaofChampionsChest.ID,
    { map: 725, x: -8595.069, y: 1488.233, z: -75.437, o: 5.249 },
    60000
); // Chest Spawn (Needs a Timer)
...
function addLootSingleChanceMultiGroup(
    chest: GameObjectChest,
    items: number[],
    chance: number,
    min: number,
