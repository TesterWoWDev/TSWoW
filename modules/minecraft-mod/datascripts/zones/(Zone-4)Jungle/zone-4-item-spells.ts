...
IntellectIV.Effects.get(0).PointsBase.set(127);
...
StaminaIV.Effects.get(0).PointsBase.set(267);
...
SpiritIV.Effects.get(0).PointsBase.set(147);
...
AgilityIV.Effects.get(0).PointsBase.set(127);
...
StrengthIV.Effects.get(0).PointsBase.set(127);
...
ProtectionIV.Effects.get(0).PointsBase.set(2349);
