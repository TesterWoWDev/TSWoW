...
RavenLordMountSpeed.Effects.get(1).BasePoints.set(49);
...
IntellectI.Effects.get(0).BasePoints.set(27);
...
StaminaI.Effects.get(0).BasePoints.set(67);
...
SpiritI.Effects.get(0).BasePoints.set(47);
...
AgilityI.Effects.get(0).BasePoints.set(27);
...
StrengthI.Effects.get(0).BasePoints.set(27);
...
ProtectionI.Effects.get(0).BasePoints.set(349);
