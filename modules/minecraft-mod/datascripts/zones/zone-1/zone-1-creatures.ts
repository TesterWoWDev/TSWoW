...
SQL.broadcast_text.add(RareCreature2.ID+1).Text.set('AWOO!').Flags.set(1)
SQL.creature_text.add(RareCreature2.ID,1,0).Text.set('AWOO!').BroadcastTextId.set(RareCreature2.ID+2).Probability.set(200).Type.set(14)
SQL.broadcast_text.add(RareCreature2.ID+2).Text.set('I SMELL...FRESH MEAT!').Flags.set(1)
SQL.creature_text.add(RareCreature2.ID,1,1).Text.set('I SMELL...FRESH MEAT!').BroadcastTextId.set(RareCreature2.ID+2).Probability.set(200).Type.set(14)
