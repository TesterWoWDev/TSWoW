...
export let ShamanQuestGiver01 = std.CreatureTemplates.create(
    MODNAME,
    "shaman01-creature",
    30368
);
...
spawnNPC(ShamanQuestGiver01.ID, 0, 0, {
    map: 725,
    x: -8364.425781,
    y: -266.700806,
    z: 10.418685,
...
ShamanQuest01.Text.Objective.enGB.set(
...
ShamanQuest01.Text.Incomplete.enGB.set(
...
ShamanQuest01.Text.Reward.enGB.set(
...
ShamanQuest02.Rewards.Item.add(RavenLordMount.ID, 1);

ShamanQuest02.Text.Objective.enGB.set(
...
ShamanQuest02.Text.Incomplete.enGB.set(
...
ShamanQuest02.Text.Description.enGB.set(
    "Collect orbs of power from around the game in various scenarios."
);
ShamanQuest02.Text.Reward.enGB.set(
