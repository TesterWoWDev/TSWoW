...
export let PriestQuestGiver01 = std.CreatureTemplates.create(
    MODNAME,
    "priest01-creature",
    30368
);
...
spawnNPC(PriestQuestGiver01.ID, 0, 0, {
    map: 725,
    x: -8210.161133,
    y: -209.308029,
    z: 3.408,
...
PriestQuest01.Text.Objective.enGB.set(
...
PriestQuest01.Text.Incomplete.enGB.set(
...
PriestQuest01.Text.Reward.enGB.set(
...
PriestQuest02.Text.Objective.enGB.set(
...
PriestQuest02.Text.Incomplete.enGB.set(
...
PriestQuest02.Text.Description.enGB.set(
    "Collect orbs of power from around the game in various scenarios."
);
PriestQuest02.Text.Reward.enGB.set(
