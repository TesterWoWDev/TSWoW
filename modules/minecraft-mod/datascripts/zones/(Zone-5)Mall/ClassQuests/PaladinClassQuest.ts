...
export let PaladinQuestGiver01 = std.CreatureTemplates.create(
    MODNAME,
    "palacin01-creature",
    30368
);
...
spawnNPC(PaladinQuestGiver01.ID, 0, 0, {
    map: 725,
    x: -8398.767578,
    y: -153.386414,
    z: 0.806448,
...
PaladinQuest01.Text.Objective.enGB.set(
...
PaladinQuest01.Text.Incomplete.enGB.set(
...
PaladinQuest01.Text.Reward.enGB.set(
...
std.SQL.quest_template_addon.add(PaladinQuest02.ID).SpecialFlags.set(1);
...
PaladinQuest02.Rewards.Item.add(RavenLordMount.ID, 1);

PaladinQuest02.Text.Objective.enGB.set(
...
PaladinQuest02.Text.Incomplete.enGB.set(
...
PaladinQuest02.Text.Description.enGB.set(
    "Collect orbs of power from around the game in various scenarios."
);
PaladinQuest02.Text.Reward.enGB.set(
