...
spawnNPC(questGiver03.ID,0,0,{map:725,x:-8292.411133,y:-271.135468,z:17.274445,o:1.4686858},) //Quest Giver 3 Spawn
...
spawnNPC(3562,0,0,{map:725,x:-8186.291504,y:13.517035,z:0.115301,o:5.435018},
) //Reagent Vendor at City Exit
setFaction(3562,35)
spawnNPC(AmuletVendor.ID,0,0,{map:725,x:-8182.976074,y:16.767733,z:0.099456,o:5.533191},
) //Amulet Vendor at City Exit

spawnGob(532751, {map:725,x:-8299.083008,y:20.426346,z:12.764252,o:0.761878}    )//NpcSpawnPortal
...
let AdventurerMageTowerGUID = spawnNPCWithTimer(AdventurerMageTower.ID,0,0,
    {map:725,x:-8299.083008,y:20.426346,z:12.764252,o:0.761878},10)
