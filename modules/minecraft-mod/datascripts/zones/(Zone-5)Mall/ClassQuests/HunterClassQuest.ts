...
export let HunterQuestGiver01 = std.CreatureTemplates.create(
    MODNAME,
    "hunter01-creature",
    30368
);
...
spawnNPC(HunterQuestGiver01.ID, 0, 0, {
    map: 725,
    x: -8331.34668,
    y: -41.606926,
    z: 0.549585,
...
HunterQuest01.Text.Objective.enGB.set(
...
HunterQuest01.Text.Incomplete.enGB.set(
...
HunterQuest01.Text.Reward.enGB.set(
...
std.SQL.quest_template_addon.add(HunterQuest02.ID).SpecialFlags.set(1);
...
HunterQuest02.Text.Objective.enGB.set(
...
HunterQuest02.Text.Incomplete.enGB.set(
...
HunterQuest02.Text.Description.enGB.set(
    "Collect orbs of power from around the game in various scenarios."
);
HunterQuest02.Text.Reward.enGB.set(
