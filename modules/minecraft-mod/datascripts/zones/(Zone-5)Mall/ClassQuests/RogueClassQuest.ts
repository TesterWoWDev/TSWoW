...
export let RogueQuestGiver01 = std.CreatureTemplates.create(
    MODNAME,
    "rogue01-creature",
    30368
);
...
spawnNPC(RogueQuestGiver01.ID, 0, 0, {
    map: 725,
    x: -8283.104492,
    y: -264.669922,
    z: -5.097,
...
RogueQuest01.Text.Objective.enGB.set(
...
RogueQuest01.Text.Incomplete.enGB.set(
...
RogueQuest01.Text.Reward.enGB.set(
...
RogueQuest02.Text.Objective.enGB.set(
...
RogueQuest02.Text.Incomplete.enGB.set(
...
RogueQuest02.Text.Description.enGB.set(
    "Collect orbs of power from around the game in various scenarios."
);
RogueQuest02.Text.Reward.enGB.set(
