...
export let FortHopePortal = std.Spells.create(
    MODNAME,
...
SQL.spell_target_position
    ...
    .PositionY.set(1792.111)
    .PositionZ.set(-71.16)
    .Orientation.set(4.755);

export let PortaltoFortHope = std.GameObjectTemplates.Plain.create(
    MODNAME,
    "forthope-object",
    183325
);
...
export let DauntlessPortal = std.Spells.create(
    MODNAME,
...
SQL.spell_target_position
    ...
    .PositionY.set(-361.08)
    .PositionZ.set(64.7468)
    .Orientation.set(0.0);

export let PortaltoDauntless = std.GameObjectTemplates.Plain.create(
    MODNAME,
    "dauntless-object",
    183325
);
...
spawnGob(PortaltoDauntless.ID, {
    map: 725,
    x: -8314.533,
    y: 19.98,
    z: 47.236,
    o: 0.305,
}); // Portal to the Dauntless Hideout

export let ApothecaryPortal = std.Spells.create(
    MODNAME,
...
SQL.spell_target_position
    ...
    .PositionY.set(-90.86)
    .PositionZ.set(-6.1379)
    .Orientation.set(4.76);

export let PortaltoApothecary = std.GameObjectTemplates.Plain.create(
    MODNAME,
    "apothecary-object",
    183325
);
...
spawnGob(PortaltoApothecary.ID, {
    map: 725,
    x: -8274.409,
    y: 31.319,
    z: 47.236,
    o: 0.305,
}); // Portal to the Apothecary

export let StoneCirclePortal = std.Spells.create(
    MODNAME,
...
SQL.spell_target_position
    ...
    .PositionY.set(411.334)
    .PositionZ.set(5.5)
    .Orientation.set(4.955);

export let PortaltoStoneCircle = std.GameObjectTemplates.Plain.create(
    MODNAME,
    "stonecircle-object",
    183325
);
...
spawnGob(PortaltoStoneCircle.ID, {
    map: 725,
    x: -8288.521,
    y: 4.945,
    z: 47.236,
    o: 0.305,
}); // Portal to the Stone Circle

export let JeweloftheSeaPortal = std.Spells.create(
    MODNAME,
...
SQL.spell_target_position
    ...
    .PositionY.set(-395.718)
    .PositionZ.set(42.1914)
    .Orientation.set(2.211);

export let PortaltoJewelofSea = std.GameObjectTemplates.Plain.create(
    MODNAME,
    "jewelofsea-object",
    183325
);
...
spawnGob(PortaltoJewelofSea.ID, {
    map: 725,
    x: -8352.683,
    y: -279.542,
    z: 0.277,
