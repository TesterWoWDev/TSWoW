...
export let node2 = makeMiningNode('Copper Vein 2',310,18,'tier2')
...
export let node3 = makeMiningNode('Copper Vein 3',310,19,'tier3')
...
export let node4 = makeMiningNode('Copper Vein 4',310,20,'tier4')
