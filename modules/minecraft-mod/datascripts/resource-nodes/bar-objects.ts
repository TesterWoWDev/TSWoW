...
export let tierOneBarNode1 = makeResourceNode('Abandoned Metal Bar',6453,57,'barnode01')
...
export let tierOneBarNode2 = makeResourceNode('Abandoned Metal Bar',6458,57,'barnode02')
...
export let tierOneBarNode3 = makeResourceNode('Abandoned Metal Bar',6459,57,'barnode03')
...
export let tierOneBarNode4 = makeResourceNode('Abandoned Metal Bar',6462,57,'barnode04')
