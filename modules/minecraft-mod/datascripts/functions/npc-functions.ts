...
export function addLootToCreature(loot: LootSetPointer<CreatureTemplate>, items: number[], chances: number[],groupID?:number) {
    if(groupID == null){
        groupID = 0
    }
...
export function addLootToCreatureSingleChance(loot: LootSetPointer<CreatureTemplate>, items: number[], chance: number,groupID?:number) {
    if(groupID == null){
        groupID = 0
    }
    loot.modRefCopy(table=>{
