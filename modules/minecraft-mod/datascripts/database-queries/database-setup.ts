...
SQL.Databases.world_dest.writeEarly('UPDATE `item_template` SET `socketbonus` = (0) WHERE `entry` > 0')
SQL.Databases.world_dest.writeEarly('UPDATE `item_template` SET `ammo_type` = (2) WHERE `entry` > 0 AND `class` = (2) AND `subclass` = (2)')
SQL.Databases.world_dest.writeEarly('UPDATE `item_template` SET `ammo_type` = (2) WHERE `entry` > 0 AND `class` = (2) AND `subclass` = (3)')
SQL.Databases.world_dest.writeEarly('UPDATE `item_template` SET `ammo_type` = (2) WHERE `entry` > 0 AND `class` = (2) AND `subclass` = (18)')
SQL.Databases.world_dest.writeEarly('UPDATE `item_template` SET `spellid_5` = (46699) WHERE `entry` > 0 AND `class` = (2) AND `subclass` = (2)')
SQL.Databases.world_dest.writeEarly('UPDATE `item_template` SET `spellid_5` = (46699) WHERE `entry` > 0 AND `class` = (2) AND `subclass` = (3)')
SQL.Databases.world_dest.writeEarly('UPDATE `item_template` SET `spellid_5` = (46699) WHERE `entry` > 0 AND `class` = (2) AND `subclass` = (18)')
SQL.Databases.world_dest.writeEarly('UPDATE `item_template` SET `spelltrigger_5` = (1) WHERE `entry` > 0 AND `class` = (2) AND `subclass` = (2)')
SQL.Databases.world_dest.writeEarly('UPDATE `item_template` SET `spelltrigger_5` = (1) WHERE `entry` > 0 AND `class` = (2) AND `subclass` = (3)')
SQL.Databases.world_dest.writeEarly('UPDATE `item_template` SET `spelltrigger_5` = (1) WHERE `entry` > 0 AND `class` = (2) AND `subclass` = (18)')
