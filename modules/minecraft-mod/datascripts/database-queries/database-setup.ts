...
SQL.Databases.world_dest.writeEarly('DROP TABLE IF EXISTS `invastion_bosses`')
SQL.Databases.world_dest.writeEarly('CREATE TABLE `invastion_bosses` (`tier` int(11) DEFAULT NULL,`entry` int(11) DEFAULT NULL)')
