...
let creature1 = std.CreatureTemplates.create(MODNAME,'Placeholder-creature1',116)
...
let creature2 = std.CreatureTemplates.create(MODNAME,'Placeholder-creature2',358)
...
let creature3 = std.CreatureTemplates.create(MODNAME,'Placeholder-creature3',113)
...
let creature4 = std.CreatureTemplates.create(MODNAME,'Placeholder-creature4',6)
...
let creature5 = std.CreatureTemplates.create(MODNAME,'Placeholder-creature5',40)
...
let creature6 = std.CreatureTemplates.create(MODNAME,'Placeholder-creature6',46)
...
let creature7 = std.CreatureTemplates.create(MODNAME,'Placeholder-creature7',127)
...
let RareCreature1 = std.CreatureTemplates.create(MODNAME,'Placeholder-RareCreature1',341)
...
let RareCreature2 = std.CreatureTemplates.create(MODNAME,'Placeholder-RareCreature2',4279)
...
let RareCreature3 = std.CreatureTemplates.create(MODNAME,'Placeholder-RareCreature3',28375)
...
let DemiBosscreature1 = std.CreatureTemplates.create(MODNAME,'Placeholder-DemiBosscreature1',4278)
...
let DemiBosscreature2 = std.CreatureTemplates.create(MODNAME,'Placeholder-DemiBosscreature2',17603)
...
let Bosscreature1 = std.CreatureTemplates.create(MODNAME,'Placeholder-Bosscreature1',3976)
