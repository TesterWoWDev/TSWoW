...
/*On Use : Health (-61)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    "Increases health by 1350 for 18 seconds.",
    sIEI++
);
/*On Use : Attack Power (-60)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    spellColorCode + "Increases attack power by 250 for 10 seconds.",
    sIEI++
);
/*On Use : Spell Power (-59)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    spellColorCode + "Increases spell power by 250 for 10 seconds.",
    sIEI++
);
/*Chance : Stun Baton (-58)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    spellColorCode + "Chance: Stuns target for 3 seconds.",
    sIEI++
);
/*Chance : Healing (-57)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    spellColorCode + "Chance: Heal 450.",
    sIEI++
);
/*Chance : Thunderfury (-56)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    spellColorCode + "Chance: Lightning Blast for 246 damage.",
    sIEI++
);
/*Chance : Shadow Bolt (-55)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    spellColorCode + "Chance: Shadow Bolt for 120 damage.",
    sIEI++
);
