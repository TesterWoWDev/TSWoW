...
// Hybrid Templates
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
/*Stamina + Strength 			(-105)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Agiity	 			(-104)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Attack Power 		(-103)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Intellect 			(-102)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Spell Power 		(-101)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Spirit 				(-100)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Haste Rating 		(-99)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Block Rating 		(-98)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Dodge Rating 		(-97)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Parry Rating 		(-96)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Hit Rating 			(-95)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Armor Penetration 	(-94)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Critical Strike 	(-93)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Stamina + Expertise 			(-92)*/ addToDBCSpellItemEnchantment(
    5,
    7,
    3,
    3,
...
/*Strength + Agility 			(-91)*/ addToDBCSpellItemEnchantment(
    5,
    4,
    3,
    3,
...
/*Strength + Stamina 			(-90)*/ addToDBCSpellItemEnchantment(
    5,
    4,
    3,
    3,
...
/*Strength + Attack Power	 	(-89)*/ addToDBCSpellItemEnchantment(
    5,
    4,
    3,
    3,
...
/*Strength + Haste Rating 		(-88)*/ addToDBCSpellItemEnchantment(
    5,
    4,
    3,
    3,
...
/*Strength + Block Rating 		(-87)*/ addToDBCSpellItemEnchantment(
    5,
    4,
    3,
    3,
...
/*Strength + Dodge Rating 		(-86)*/ addToDBCSpellItemEnchantment(
    5,
    4,
    3,
    3,
...
/*Strength + Parry Rating 		(-85)*/ addToDBCSpellItemEnchantment(
    5,
    4,
    3,
    3,
...
/*Strength + Hit Rating 		(-84)*/ addToDBCSpellItemEnchantment(
    5,
    4,
    3,
    3,
...
/*Strength + Armor Penetration 	(-83)*/ addToDBCSpellItemEnchantment(
    5,
    4,
    3,
    3,
...
/*Strength + Critical Strike 	(-82)*/ addToDBCSpellItemEnchantment(
    5,
    4,
    3,
    3,
...
/*Strength + Expertise 			(-81)*/ addToDBCSpellItemEnchantment(
    5,
    4,
    3,
    3,
...
/*Agility + Stamina 			(-80)*/ addToDBCSpellItemEnchantment(
    5,
    3,
    3,
    3,
...
/*Agility + Attack Power	 	(-79)*/ addToDBCSpellItemEnchantment(
    5,
    3,
    3,
    3,
...
/*Agility + Haste Rating 		(-78)*/ addToDBCSpellItemEnchantment(
    5,
    3,
    3,
    3,
...
/*Agility + Block Rating 		(-77)*/ addToDBCSpellItemEnchantment(
    5,
    3,
    3,
    3,
...
/*Agility + Dodge Rating 		(-76)*/ addToDBCSpellItemEnchantment(
    5,
    3,
    3,
    3,
...
/*Agility + Parry Rating 		(-75)*/ addToDBCSpellItemEnchantment(
    5,
    3,
    3,
    3,
...
/*Agility + Hit Rating 			(-74)*/ addToDBCSpellItemEnchantment(
    5,
    3,
    3,
    3,
...
/*Agility + Armor Penetration 	(-73)*/ addToDBCSpellItemEnchantment(
    5,
    3,
    3,
    3,
...
/*Agility + Critical Strike 	(-72)*/ addToDBCSpellItemEnchantment(
    5,
    3,
    3,
    3,
...
/*Agility + Expertise 			(-71)*/ addToDBCSpellItemEnchantment(
    5,
    3,
    3,
    3,
...
/*Intellect + Stamina 			(-70)*/ addToDBCSpellItemEnchantment(
    5,
    5,
    3,
    3,
...
/*Intellect + Spell Power 		(-69)*/ addToDBCSpellItemEnchantment(
    5,
    5,
    3,
    3,
...
/*Intellect + Haste Rating 		(-68)*/ addToDBCSpellItemEnchantment(
    5,
    5,
    3,
    3,
...
/*Intellect + Hit Rating 		(-67)*/ addToDBCSpellItemEnchantment(
    5,
    5,
    3,
    3,
...
/*Intellect + Spell Penetration	(-66)*/ addToDBCSpellItemEnchantment(
    5,
    5,
    3,
    3,
...
/*Intellect + Critical Strike 	(-65)*/ addToDBCSpellItemEnchantment(
    5,
    5,
    3,
    3,
...
/*Intellect + Mana per 5 		(-64)*/ addToDBCSpellItemEnchantment(
    5,
    5,
    3,
    3,
...
/*Intellect + Expertise 		(-63)*/ addToDBCSpellItemEnchantment(
    5,
    5,
    3,
    3,
...
/*Intellect + Spirit 			(-62)*/ addToDBCSpellItemEnchantment(
    5,
    5,
    3,
    3,
...
/*On Use : Health (-61)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    "Increases health by 350 for 18 seconds.",
    sIEI++
);
/*On Use : Attack Power (-60)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    spellColorCode + "Increases attack power by 50 for 10 seconds.",
    sIEI++
);
/*On Use : Spell Power (-59)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    spellColorCode + "Increases spell power by 50 for 10 seconds.",
    sIEI++
);
/*Chance : Stun Baton (-58)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    spellColorCode + "Chance: Stuns target for 1 seconds.",
    sIEI++
);
...
/*Chance : Healing (-57)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    spellColorCode + "Chance: Heal 100.",
    sIEI++
);
/*Chance : Thunderfury (-56)*/ addToDBCSpellItemEnchantment(
    3,
    chanceLightning1M.ID,
    0,
    0,
    3,
    chanceLightning1C.ID,
    0,
    0,
    spellColorCode + "Chance: Lightning Blast for 100 damage.",
    sIEI++
);
/*Chance : Shadow Bolt (-55)*/ addToDBCSpellItemEnchantment(
    ...
    0,
    0,
    spellColorCode + "+ Chance: Shadow Bolt for 30 damage.",
    sIEI++
);
...
addToDBCItemRandomProperties(
    ...
    9.9,
    sIEI
); /*Intellect + Spirit + Spellpower           9.9% Chance*/
addToDBCItemRandomProperties(
    "of Anarchy",
    pI++,
    clothTierOneItemEnchantmentIndex,
    ...
    9.9,
    sIEI
); /*Intellect + Haste + Spellpower            9.9% Chance*/
addToDBCItemRandomProperties(
    "of Torment",
    pI++,
    clothTierOneItemEnchantmentIndex,
...
addToDBCItemRandomProperties(
    ...
    9.9,
    sIEI
); /*Spellpower + Spellpower + Hit             9.9% Chance*/
addToDBCItemRandomProperties(
    "of Dying Light",
    pI++,
    clothTierOneItemEnchantmentIndex,
    ...
    9.9,
    sIEI
); /*Spellpower + Mana per 5 + Haste           9.9% Chance*/
addToDBCItemRandomProperties(
    "of Renewed Hope",
    pI++,
    clothTierOneItemEnchantmentIndex,
    ...
    9.9,
    sIEI
); /*Health per 5 + Mana per 5                 9.9% Chance*/
addToDBCItemRandomProperties(
    "of Vigour",
    pI++,
    clothTierOneItemEnchantmentIndex,
    ...
    9.9,
    sIEI
); /*Spellpower + Crit + Spell Pen             9.9% Chance*/
addToDBCItemRandomProperties(
    "of Torture",
    pI++,
    clothTierOneItemEnchantmentIndex,
    ...
    9.9,
    sIEI
); /*Spellpower + Hit + Crit                   9.9% Chance*/
addToDBCItemRandomProperties(
    "of Heartrending",
    pI++,
    clothTierOneItemEnchantmentIndex,
    ...
    9.9,
    sIEI
); /*Health + Health per 5                     9.9% Chance*/
...
addToDBCItemRandomProperties(
    ...
    1,
    sIEI
); /*Chance to Thunderfury             1% Chance*/
addToDBCItemRandomProperties(
    "of the Immortal",
    pI++,
    weaponTierOneItemEnchantmentIndex,
...
addToDBCItemRandomProperties(
    ...
    1,
    sIEI
); /*Chance to Send Shadowbolts        1% Chance*/
