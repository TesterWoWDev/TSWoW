...
/*On Use : Attack Power (-60)*/     addSpell(7,attackpower1.ID,0,0,0,0,0,0,'Increases attack power by 50 for 10 seconds.',sIEI++)
/*On Use : Spell Power (-59)*/      addSpell(7,spellpower1.ID,0,0,0,0,0,0,'Increases spell power by 50 for 10 seconds.',sIEI++)
/*Chance : Stun Baton (-58)*/       addSpell(1,chanceStun1.ID,0,0,0,0,0,0,redColorCode + 'Chance: Stuns target for 1 seconds.',sIEI++)
/*Chance : Healing (-57)*/          addSpell(1,chanceHeal1.ID,0,0,0,0,0,0,redColorCode + 'Chance: Heal 100.',sIEI++)
/*Chance : Thunderfury (-56)*/      addSpell(1,chanceLightning1.ID,0,0,0,0,0,0,redColorCode + 'Chance: Lightning Blast for 100 damage.',sIEI++)
/*Chance : Shadow Bolt (-55)*/      addSpell(1,chanceShadow1.ID,0,0,0,0,0,0,redColorCode + '+ Chance: Shadow Bolt for 30 damage.',sIEI++)
