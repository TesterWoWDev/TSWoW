...
/*Chance : Stun Baton (-58)*/ DBC_SpellItemEnchantment.add(SpellItemEnchantmentIndex++).Effect.setIndex(0,1).EffectArg.setIndex(0,chanceStun1.ID).Name.enGB.set(redColorCode + 'Chance: Stuns target for 1 seconds.').ItemVisual.set(0).Flags.set(0)
/*Chance : Healing (-57)*/ DBC_SpellItemEnchantment.add(SpellItemEnchantmentIndex++).Effect.setIndex(0,1).EffectArg.setIndex(0,chanceHeal1.ID).Name.enGB.set(redColorCode + 'Chance: Heal 100.').ItemVisual.set(0).Flags.set(0)
/*Chance : Thunderfury (-56)*/ DBC_SpellItemEnchantment.add(SpellItemEnchantmentIndex++).Effect.setIndex(0,1).EffectArg.setIndex(0,chanceLightning1.ID).Name.enGB.set(redColorCode + 'Chance: Lightning Blast for 100 damage.').ItemVisual.set(0).Flags.set(0)
/*Chance : Shadow Bolt (-55)*/ DBC_SpellItemEnchantment.add(SpellItemEnchantmentIndex++).Effect.setIndex(0,1).EffectArg.setIndex(0,chanceShadow1.ID).Name.enGB.set(redColorCode + '+ Chance: Shadow Bolt for 30 damage.').ItemVisual.set(0).Flags.set(0)
