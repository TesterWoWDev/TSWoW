...
tierThreeMailGear.push(createTrinket(levelrequirement,'tier1-mail',2,100,trinketTierThreeItemEnchantmentIndex,'Officer\'s Polished Trinket',31287,armSpell,armTrigger))
...
tierThreeLeatherGear.push(createTrinket(levelrequirement,'tier1-leather',2,100,trinketTierThreeItemEnchantmentIndex,'Officer\'s Polished Trinket',39915,armSpell,armTrigger))
...
tierThreeClothGear.push(createTrinket(levelrequirement,'tier1-cloth',2,100,trinketTierThreeItemEnchantmentIndex,'Officer\'s Polished Trinket',53454,armSpell,armTrigger))
