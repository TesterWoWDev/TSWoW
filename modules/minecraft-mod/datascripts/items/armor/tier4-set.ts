...
tierFourMailGear.push(createTrinket(levelrequirement,'tier4-mail',3,103,trinketTierFourItemEnchantmentIndex,'General\'s Relinquished Trinket',39917,armSpell,armTrigger))
...
tierFourLeatherGear.push(createTrinket(levelrequirement,'tier4-leather',3,103,trinketTierFourItemEnchantmentIndex,'General\'s Relinquished Trinket',39918,armSpell,armTrigger))
...
tierFourClothGear.push(createTrinket(levelrequirement,'tier4-cloth',3,103,trinketTierFourItemEnchantmentIndex,'General\'s Relinquished Trinket',48971,armSpell,armTrigger))
