...
import { clothTierTwoItemEnchantmentIndex, leatherTierTwoItemEnchantmentIndex, mailTierTwoItemEnchantmentIndex, trinketTierTwoItemEnchantmentIndex, weaponTierTwoItemEnchantmentIndex } from "../RandomProperties/tier2-properties"
...
export let tierTwoMailGear = createGear(levelrequirement,'tier2-mail',2,2.5,3,101,mailTierTwoItemEnchantmentIndex,['Initiate\'s Rusty Helm','Initiate\'s Rusty Necklace','Initiate\'s Rusty Spaulders','Initiate\'s Rusty Cloak','Initiate\'s Rusty Chestguard','Initiate\'s Rusty Bracers','Initiate\'s Rusty Gloves','Initiate\'s Rusty Belt','Initiate\'s Rusty Legguards','Initiate\'s Rusty Greaves','Initiate\'s Rusty Ring'],[22908,34034,28725,26278,28819,28844,15816,27951,28623,28383,18365],armSpell,armTrigger)
tierTwoMailGear.push(createTrinket(levelrequirement,'tier2-mail',2,101,trinketTierTwoItemEnchantmentIndex,'Initiate\'s Rusty Trinket',43431,armSpell,armTrigger))
export let tierTwoLeatherGear = createGear(levelrequirement,'tier2-leather',2,2.2,2,101,leatherTierTwoItemEnchantmentIndex,['Initiate\'s Rusty Hat','Initiate\'s Rusty Necklace','Initiate\'s Rusty Shoulderpads','Initiate\'s Rusty Cloak','Initiate\'s Rusty Chestpad','Initiate\'s Rusty Bracers','Initiate\'s Rusty Gloves','Initiate\'s Rusty Belt','Initiate\'s Rusty Pants','Initiate\'s Rusty Boots','Initiate\'s Rusty Ring'],[24933,34034,19113,26278,8721,28844,13681,24978,16764,25233,9837],armSpell,armTrigger)
tierTwoLeatherGear.push(createTrinket(levelrequirement,'tier2-leather',2,101,trinketTierTwoItemEnchantmentIndex,'Initiate\'s Rusty Trinket',18047,armSpell,armTrigger))
export let tierTwoClothGear = createGear(levelrequirement,'tier2-cloth',2,2,1,101,clothTierTwoItemEnchantmentIndex,['Initiate\'s Rusty Headress','Initiate\'s Rusty Necklace','Initiate\'s Rusty Shoulders','Initiate\'s Rusty Cloak','Initiate\'s Rusty Chestpiece','Initiate\'s Rusty Bracers','Initiate\'s Rusty Gloves','Initiate\'s Rusty Belt','Initiate\'s Rusty Leggings','Initiate\'s Rusty Mocassins','Initiate\'s Rusty Ring'],[25693,34034,16497,26278,19012,28844,29898,17224,17151,17215,23629],armSpell,armTrigger)
tierTwoClothGear.push(createTrinket(levelrequirement,'tier2-cloth',2,101,trinketTierTwoItemEnchantmentIndex,'Initiate\'s Rusty Trinket',29947,armSpell,armTrigger))
...
SQL.disenchant_loot_template.add(101,tierTwoBaseResources[6]).Chance.set(100).MinCount.set(1).MaxCount.set(3).LootMode.set(1).GroupId.set(1).Reference.set(0).Comment.set('Tier 2 Disenchant - Dust')
