...
WornMace.DisplayInfo.modRefCopy(value=>value.copyFromTemplate(36685))
WornMace.Quality.WHITE.set()
...
WornWoodenShield.DisplayInfo.modRefCopy(value=>value.copyFromTemplate(28153))
WornWoodenShield.Quality.WHITE.set()
...
PrimativeMantle.Quality.WHITE.set()
...
PrimativeKilt.Quality.WHITE.set()
...
BentStaff.DisplayInfo.modRefCopy(value=>value.copyFromTemplate(43927))
BentStaff.Quality.WHITE.set()
...
ApprenticeRobe.Quality.WHITE.set()
