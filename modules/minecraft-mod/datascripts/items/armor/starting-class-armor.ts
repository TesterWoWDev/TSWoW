...
WornMace.DisplayInfo.modRef(value=>value.copyFromTemplate(36685))
...
WornWoodenShield.DisplayInfo.modRef(value=>value.copyFromTemplate(28153))
...
BentStaff.DisplayInfo.modRef(value=>value.copyFromTemplate(43927))
