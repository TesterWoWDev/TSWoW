...
std.CreatureTemplates.load(78).Vendor.addItem(BlueMiningAxe.ID,1,3600,0)
std.CreatureTemplates.load(78).Vendor.addItem(BlueShortSword.ID,1,3600,0)
std.CreatureTemplates.load(78).Vendor.addItem(SlowFallShield.ID,1,3600,0)
std.CreatureTemplates.load(78).Vendor.addItem(VikingHelmet.ID,1,3600,0)
std.CreatureTemplates.load(78).Vendor.addItem(Hammerofflames.ID,1,3600,0)
std.CreatureTemplates.load(78).Vendor.addItem(SpearofFate.ID,1,3600,0)
std.CreatureTemplates.load(78).Vendor.addItem(StolenRoyalGown.ID,1,3600,0)
std.CreatureTemplates.load(78).Vendor.addItem(DeathClutch.ID,1,3600,0)
std.CreatureTemplates.load(78).Vendor.addItem(KnowledgeTome.ID,1,3600,0)
std.CreatureTemplates.load(78).Vendor.addItem(MantleoftheSoulEater.ID,1,3600,0)
std.CreatureTemplates.load(78).Vendor.addItem(FocusStick.ID,1,3600,0)
