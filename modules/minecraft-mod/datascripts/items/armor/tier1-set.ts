...
tierOneMailGear.push(createTrinket(levelrequirement,'tier1-mail',2,100,mailTierOneItemEnchantmentIndex,'Trainee\'s Worn Trinket',9637,armSpell,armTrigger))
...
tierOneLeatherGear.push(createTrinket(levelrequirement,'tier1-leather',2,100,leatherTierOneItemEnchantmentIndex,'Trainee\'s Worn Trinket',22794,armSpell,armTrigger))
...
tierOneClothGear.push(createTrinket(levelrequirement,'tier1-cloth',2,100,clothTierOneItemEnchantmentIndex,'Trainee\'s Worn Trinket',15771,armSpell,armTrigger))
