...
import { clothTierOneItemEnchantmentIndex, leatherTierOneItemEnchantmentIndex, mailTierOneItemEnchantmentIndex, trinketTierOneItemEnchantmentIndex, weaponTierOneItemEnchantmentIndex } from "../RandomProperties/tier1-properties"
...
tierOneLeatherGear.push(createTrinket(levelrequirement,'tier1-leather',2,100,trinketTierOneItemEnchantmentIndex,'Trainee\'s Worn Trinket',22794,armSpell,armTrigger))
export let tierOneClothGear = createGear(levelrequirement,'tier1-cloth',2,1,1,100,clothTierOneItemEnchantmentIndex,['Trainee\'s Worn Headress','Trainee\'s Worn Necklace','Trainee\'s Worn Shoulders','Trainee\'s Worn Cloak','Trainee\'s Worn Chestpiece','Trainee\'s Worn Bracers','Trainee\'s Worn Gloves','Trainee\'s Worn Belt','Trainee\'s Worn Leggings','Trainee\'s Worn Mocassins','Trainee\'s Worn Ring'],[15314,9853,17135,23068,8721,8089,13681,24978,24927,24935,9823],armSpell,armTrigger)
tierOneClothGear.push(createTrinket(levelrequirement,'tier1-cloth',2,100,trinketTierOneItemEnchantmentIndex,'Trainee\'s Worn Trinket',15771,armSpell,armTrigger))
