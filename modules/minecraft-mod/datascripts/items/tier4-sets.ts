...
export let tierFourBaseResources = createBaseResources('tier4','|cff7719C6Pristine',['Blood Garnet','Epulets','chain','Metal','Reinforced Metal'],[35916,35338,39340,7355,7389])

export let tierFourMailMaterial = createMaterial('tier4','|cff7719C6Pristine Mail Scraps','mail armor pieces',22924)
export let tierFourLeatherMaterial = createMaterial('tier4','|cff7719C6Pristine Leather Scraps','leather armor pieces',29468)
export let tierFourClothMaterial = createMaterial('tier4','|cff7719C6Pristine Cloth Scraps','cloth armor pieces',7383)
