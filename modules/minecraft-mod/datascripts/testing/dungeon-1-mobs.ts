...
LightningTotemBolt.Effects.get(0).BasePoints.set(325);
LightningTotemBolt.Effects.get(0).DieSides.set(121);
...
LightningNetDamage.Effects.get(0).BasePoints.set(216);
LightningNetDamage.Effects.get(0).DieSides.set(75);
...
DungeonMob01Spell03.Effects.get(0).BasePoints.set(2)
DungeonMob01Spell03.Effects.get(0).DieSides.set(1)
...
HealingWardHeal.Effects.get(0).BasePoints.set(765)
HealingWardHeal.Effects.get(0).DieSides.set(210)
...
export let mobOne = std.CreatureTemplates.create(MODNAME,'torghastmob1',8912) //Normal Caster Mob
...
DungeonMob02Spell01.Effects.get(0).BasePoints.set(299)
DungeonMob02Spell01.Effects.get(0).DieSides.set(1)
...
DungeonMob02Spell02.Effects.get(0).BasePoints.set(540)
DungeonMob02Spell02.Effects.get(0).DieSides.set(519)
...
DungeonMob02Spell03.Effects.get(0).BasePoints.set(49)
DungeonMob02Spell03.Effects.get(0).DieSides.set(1)
...
DungeonMob02Spell04.Effects.get(0).BasePoints.set(219)
DungeonMob02Spell04.Effects.get(0).DieSides.set(122)
DungeonMob02Spell04.Effects.get(1).BasePoints.set(-21)
DungeonMob02Spell04.Effects.get(1).DieSides.set(1)

export let mobTwo = std.CreatureTemplates.create(MODNAME,'torghastmob2',34980) //Normal Melee Mob
...
DungeonMob03Spell02.Effects.get(0).BasePoints.set(259)
DungeonMob03Spell02.Effects.get(0).DieSides.set(1)

export let mobThree = std.CreatureTemplates.create(MODNAME,'torghastmob3',34980) //Normal Tank Mob
