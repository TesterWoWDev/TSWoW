...
TorghastBoss1.Stats.DamageMod.set(4);
TorghastBoss1.Stats.HealthMod.set(25);
...
ShamanGuard1.Stats.DamageMod.set(2);
ShamanGuard1.Stats.HealthMod.set(3);
...
TorghastBoss2.Stats.DamageMod.set(6);
TorghastBoss2.Stats.HealthMod.set(8);
...
TorghastBoss3.Stats.DamageMod.set(6);
TorghastBoss3.Stats.HealthMod.set(15);
...
TorghastBoss5.Stats.DamageMod.set(6);
TorghastBoss5.Stats.HealthMod.set(18);
...
TorghastBoss5.InlineScripts.OnJustEnteredCombat((creature, target) => {
    ...
    creature.AddTimer("event1", 7000, -1, (timer, entity, del, can) => {
        ...
        attemptCast(GetID("Spell", "minecraft-mod", "boss5energize1-spell"),entity.ToCreature(),self.GetVictim(),false);
    });
