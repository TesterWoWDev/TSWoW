...
health1.Effects.get(0).AuraType.setModIncreaseHealth()
health1.Effects.get(0).BasePoints.set(349)
health1.Effects.get(1).BasePoints.set(-1)
health1.Duration.set(18000,0,0)
...
health2.Duration.set(18000,0,0)
...
health3.Duration.set(18000,0,0)
...
health4.Duration.set(18000,0,0)
