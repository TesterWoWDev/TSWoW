...
health1.Effects.get(0).PointsBase.set(349);
health1.Effects.get(1).PointsBase.set(-1);
...
health1.Effects.get(0).Aura.MOD_INCREASE_HEALTH.set();
health2.Effects.get(0).PointsBase.set(749);
health2.Effects.get(1).PointsBase.set(-1);
...
health1.Effects.get(0).Aura.MOD_INCREASE_HEALTH.set();
health3.Effects.get(0).PointsBase.set(1349);
health3.Effects.get(1).PointsBase.set(-1);
...
health1.Effects.get(0).Aura.MOD_INCREASE_HEALTH.set();
health4.Effects.get(0).PointsBase.set(1749);
health4.Effects.get(1).PointsBase.set(-1);
