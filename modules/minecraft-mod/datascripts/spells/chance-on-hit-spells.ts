...
export let chanceStun1M = std.Spells.create(
    MODNAME,
    "chanceStun1M-spell",
    67670
); //melee
chanceStun1M.Name.enGB.set("Smashed");
chanceStun1M.Description.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 1 second."
);
chanceStun1M.AuraDescription.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 1 second."
);
...
export let chanceStun1C = std.Spells.create(
    MODNAME,
    "chanceStun1C-spell",
    67672
); //caster
chanceStun1C.Name.enGB.set("Smashed");
chanceStun1C.Description.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 1 second."
);
chanceStun1C.AuraDescription.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 1 second."
);
...
export let chanceStun2M = std.Spells.create(
    MODNAME,
    "chanceStun2M-spell",
    67670
); //melee
chanceStun2M.Name.enGB.set("Smashed");
chanceStun2M.Description.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 2 seconds."
);
chanceStun2M.AuraDescription.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 2 seconds."
);
...
export let chanceStun2C = std.Spells.create(
    MODNAME,
    "chanceStun2C-spell",
    67672
); //caster
chanceStun2C.Name.enGB.set("Smashed");
chanceStun2C.Description.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 2 seconds."
);
chanceStun2C.AuraDescription.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 2 seconds."
);
...
export let chanceStun3M = std.Spells.create(
    MODNAME,
    "chanceStun3M-spell",
    67670
); //melee
chanceStun3M.Name.enGB.set("Smashed");
chanceStun3M.Description.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 2 seconds."
);
chanceStun3M.AuraDescription.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 2 seconds."
);
...
export let chanceStun3C = std.Spells.create(
    MODNAME,
    "chanceStun3C-spell",
    67672
); //caster
chanceStun3C.Name.enGB.set("Smashed");
chanceStun3C.Description.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 2 seconds."
);
chanceStun3C.AuraDescription.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 2 seconds."
);
...
export let chanceStun4M = std.Spells.create(
    MODNAME,
    "chanceStun4M-spell",
    67670
); //melee
chanceStun4M.Name.enGB.set("Smashed");
chanceStun4M.Description.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 2 seconds."
);
chanceStun4M.AuraDescription.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 2 seconds."
);
...
export let chanceStun4C = std.Spells.create(
    MODNAME,
    "chanceStun4C-spell",
    67672
); //caster
chanceStun4C.Name.enGB.set("Smashed");
chanceStun4C.Description.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 2 seconds."
);
chanceStun4C.AuraDescription.enGB.set(
    "Your attacks and abilties have the chance to stun your target for 2 seconds."
);
...
export let chanceHeal1C = std.Spells.create(
    MODNAME,
    "chanceHeal1C-spell",
    67672
); //caster
...
export let chanceLightning1 = std.Spells.create(
    MODNAME,
    "chanceLightning1-spell",
    21992
); //15283
...
export let chanceLightning1M = std.Spells.create(
    MODNAME,
    "chanceLightning1M-spell",
    67670
); //melee
chanceLightning1M.Name.enGB.set("thundered");
chanceLightning1M.Description.enGB.set(
    "Your attacks and abilties have the chance to thunder."
);
chanceLightning1M.AuraDescription.enGB.set(
    "Your attacks and abilties have the chance to thunder."
);
...
export let chanceLightning1C = std.Spells.create(
    MODNAME,
    "chanceLightning1C-spell",
    67672
); //caster
chanceLightning1C.Name.enGB.set("thundered");
chanceLightning1C.Description.enGB.set(
    "Your attacks and abilties have the chance to thunder."
);
chanceLightning1C.AuraDescription.enGB.set(
    "Your attacks and abilties have the chance to thunder."
);
...
export let chanceLightningExtra2 = std.Spells.create(
    MODNAME,
    "chanceLightningExtra2-spell",
    27648
);
...
export let chanceLightningExtra3 = std.Spells.create(
    MODNAME,
    "chanceLightningExtra3-spell",
    27648
);
...
export let chanceLightningExtra4 = std.Spells.create(
    MODNAME,
    "chanceLightningExtra4-spell",
    27648
);
...
// Shadow Bolt
export let chanceShadow1 = std.Spells.create(
    MODNAME,
    "chanceShadow1-spell",
    13440
);
...
export let chanceShadow2 = std.Spells.create(
    MODNAME,
    "chanceShadow2-spell",
    13440
);
...
export let chanceShadow3 = std.Spells.create(
    MODNAME,
    "chanceShadow3-spell",
    13440
);
...
export let chanceShadow4 = std.Spells.create(
    MODNAME,
    "chanceShadow4-spell",
    13440
);
