...
chanceLightning2.Effects.get(2).TriggerSpell.set(chanceLightningExtra1.ID)
...
chanceLightning3.Effects.get(2).TriggerSpell.set(chanceLightningExtra1.ID)
...
chanceLightning4.Effects.get(2).TriggerSpell.set(chanceLightningExtra1.ID)
