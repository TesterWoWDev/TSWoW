...
expSpell.Effects.get(0).PointsBase.set(0);
expSpell.Effects.get(1).PointsBase.set(0);
...
expSpell2.Effects.get(0).PointsBase.set(1);
expSpell2.Effects.get(1).PointsBase.set(1);
...
expSpell3.Effects.get(0).PointsBase.set(2);
expSpell3.Effects.get(1).PointsBase.set(2);
...
expSpell4.Effects.get(0).PointsBase.set(3);
expSpell4.Effects.get(1).PointsBase.set(3);
...
HeirloomExperienceRates.Effects.get(0).PointsBase.set(99);
HeirloomExperienceRates.Effects.get(1).PointsBase.set(99);
