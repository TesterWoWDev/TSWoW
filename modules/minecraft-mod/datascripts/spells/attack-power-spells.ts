...
export let attackpower2 = std.Spells.create(MODNAME,'attackpower2-spell',34747)
attackpower2.Name.enGB.set('Escalating Power')
attackpower2.Description.enGB.set('Attack Power increased by $s1.')
attackpower2.Effects.get(0).AuraType.setModAttackPower()
...
export let attackpower3 = std.Spells.create(MODNAME,'attackpower3-spell',34747)
attackpower3.Name.enGB.set('Escalating Power')
attackpower3.Description.enGB.set('Attack Power increased by $s1.')
attackpower3.Effects.get(0).AuraType.setModAttackPower()
...
export let attackpower4 = std.Spells.create(MODNAME,'attackpower4-spell',34747)
attackpower4.Name.enGB.set('Escalating Power')
attackpower4.Description.enGB.set('Attack Power increased by $s1.')
attackpower4.Effects.get(0).AuraType.setModAttackPower()
