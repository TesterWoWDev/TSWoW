...
spellpower1.Description.enGB.set("Spell Power increased by $s1.");
spellpower1.Effects.get(0).PointsBase.set(49);
spellpower1.Effects.get(1).PointsBase.set(49);
...
spellpower2.Description.enGB.set("Spell Power increased by $s1.");
spellpower2.Effects.get(0).PointsBase.set(149);
spellpower2.Effects.get(1).PointsBase.set(149);
...
spellpower3.Description.enGB.set("Spell Power increased by $s1.");
spellpower3.Effects.get(0).PointsBase.set(249);
spellpower3.Effects.get(1).PointsBase.set(249);
...
spellpower4.Description.enGB.set("Spell Power increased by $s1.");
spellpower4.Effects.get(0).PointsBase.set(349);
spellpower4.Effects.get(1).PointsBase.set(349);
