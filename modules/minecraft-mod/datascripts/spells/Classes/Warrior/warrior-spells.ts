...
FuriousStrikeRank01.Duration.set(0,0,0)
...
FuriousStrikeRank01.Effects.get(1).AuraType.set(0)
FuriousStrikeRank01.Icon.set('Interface\\Icons\\Spell_Fire_EnchantWeapon')
...
FuriousStrikeRank02.Duration.set(0,0,0)
FuriousStrikeRank02.Effects.get(0).BasePoints.set(49)                               //Rank 2 - 50% weapon damage + 30
FuriousStrikeRank02.Effects.get(1).EffectType.setSchoolDamage()
FuriousStrikeRank02.Effects.get(1).BasePoints.set(29)
FuriousStrikeRank02.Effects.get(1).AuraType.set(0)
FuriousStrikeRank02.Icon.set('Interface\\Icons\\Spell_Fire_EnchantWeapon')
...
FuriousStrikeRank03.Duration.set(0,0,0)
FuriousStrikeRank03.Effects.get(0).BasePoints.set(74)                               //Rank 3 - 75% weapon damage + 50
FuriousStrikeRank03.Effects.get(1).EffectType.setSchoolDamage()
FuriousStrikeRank03.Effects.get(1).BasePoints.set(49)
FuriousStrikeRank03.Effects.get(1).AuraType.set(0)
FuriousStrikeRank03.Icon.set('Interface\\Icons\\Spell_Fire_EnchantWeapon')
...
FuriousStrikeRank04.Duration.set(0,0,0)
FuriousStrikeRank04.Effects.get(0).BasePoints.set(99)                               //Rank 4 - 100% weapon damage + 70
FuriousStrikeRank04.Effects.get(1).EffectType.setSchoolDamage()
FuriousStrikeRank04.Effects.get(1).BasePoints.set(69)
FuriousStrikeRank04.Effects.get(1).AuraType.set(0)
FuriousStrikeRank04.Icon.set('Interface\\Icons\\Spell_Fire_EnchantWeapon')
...
Vengeance01.Name.enGB.set('Vengeance')
Vengeance01.Duration.set(5000,0,5000)
...
Vengeance01.Icon.set('Interface\\Icons\\INV_Banner_03')
...
Vengeance02.Name.enGB.set('Vengeance')
Vengeance02.Duration.set(6000,0,6000)
...
Vengeance02.Icon.set('Interface\\Icons\\INV_Banner_03')
...
Vengeance03.Name.enGB.set('Vengeance')
Vengeance03.Duration.set(7000,0,7000)
...
Vengeance03.Icon.set('Interface\\Icons\\INV_Banner_03')
...
Vengeance04.Name.enGB.set('Vengeance')
Vengeance04.Duration.set(8000,0,8000)
...
Vengeance04.Icon.set('Interface\\Icons\\INV_Banner_03')
