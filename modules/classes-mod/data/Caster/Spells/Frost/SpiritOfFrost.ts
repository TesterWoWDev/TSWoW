...
const SPIRITFROST = std.Spells.create (MODNAME,'SpiritOfFrost',69090).SkillLines.add(FROST_SKILL.ID).setAutolearn().end; //Frozen skin deals aoe damage when attacked by an enemy. Lasts 60 minutes.
