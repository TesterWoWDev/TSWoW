...
const FROZENSKIN = std.Spells.create (MODNAME,'FrozenSkin',11).SkillLines.add(FROST_SKILL.ID).setAutolearn().end; //Frozen skin deals aoe damage when attacked by an enemy. Lasts 60 minutes.
...
FROZENSKIN.Duration.set(60000000,0,60000000)
FROZENSKIN.Effects.add()
    ...
    FROZENSKIN.Effects.get(0).ImplicitTargetA.setDestCaster()
...
FROZENSKIN.Effects.add()
    ...
    FROZENSKIN.Effects.get(1).ImplicitTargetA.setDestCaster()