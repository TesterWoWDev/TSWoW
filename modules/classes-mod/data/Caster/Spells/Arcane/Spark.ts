...
SPARK.Description.enGB.set('Throws pure arcane magic that causes $s1% Arcane damage and an additional $3% over 4 sec.')
SPARK.SchoolMask.set(64)
console.log(SPARK.Effects.objectify())
...
const SPARK2 = std.Spells.create(MODNAME,'arcane-spark-rank-2',SPARK.ID)
...
const SPARK3 = std.Spells.create(MODNAME,'arcane-spark-rank-3',SPARK.ID)
...
const SPARK4 = std.Spells.create(MODNAME,'arcane-spark-rank-3',SPARK.ID)
...
const SPARK5 = std.Spells.create(MODNAME,'arcane-spark-rank-3',SPARK.ID)
...
const SPARK6 = std.Spells.create(MODNAME,'arcane-spark-rank-3',SPARK.ID)
...
const SPARK7 = std.Spells.create(MODNAME,'arcane-spark-rank-3',SPARK.ID)
