...
const AOETAUNT = std.Spells.create(MODNAME, 'AOE TAUNT NAME HERE', 1161).SkillLines.add(DEFENDER_SKILL.ID).AcquireMethod.set(0).end;
    MELEE_SKILL_TRAINER.Trainer.addSpell(AOETAUNT.ID,10,19)//CHANGE LATER
AOETAUNT.Name.enGB.set('AOE TAUNT NAME HERE')
